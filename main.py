...
A console application for simulating options trading strategies
"""
...
class OptionsSimulator:
    """Main application class for options trading simulation"""
    ...
    def configure_simulation(self):
        ...
        try:
            ...
            self.config = SimulationConfig(capital, risk, max_trades, days)
    ...
    def run(self):
        ...
        print("This tool helps you simulate options trading strategies without real money.")
